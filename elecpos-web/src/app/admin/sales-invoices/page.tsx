// src/app/reports/sales-invoices/page.tsx
export const dynamic = "force-dynamic";
import { supabaseServer } from "../../../lib/supabase-server";
import SalesInvoicesReport from "../../../components/SalesInvoicesReport";
...
export default async function SalesInvoicesPage({ searchParams }: { searchParams: Search }) {
  const from =
  ...
  const { data, error } = await s.rpc("report_sales", { p_from: from, p_to: to });
  if (error) {
    return (
